...
for each in train_df.iterrows():
    ...
    nl_list = twitter.morphs(each[1]['name'])
    ...
    re_result = p.findall(name) # 한글과 띄어쓰기를 제외한 모든 부분을 제거
    """
...
svc_param = {'C':np.logspace(-2,-1,20)}
...
name='[해외]IntelIntel Core i5-4690 Processor'
img=''
